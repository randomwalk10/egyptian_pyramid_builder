if [[ "$1" == "s" ]]; then
	echo "single mode"
	g++ -D SINGLE_OUTPUT -std=c++11 -O4 -c ./dm_img_proc_lib_basics.cpp
	g++ -D SINGLE_OUTPUT -std=c++11 -O4 -c ./dm_egyptian_pyramid_lib.cpp
	g++ -D SINGLE_OUTPUT -std=c++11 -O4 -c ./dm_img_lrucache_lib.cpp
	g++ -D SINGLE_OUTPUT -std=c++11 -O4 -c ./main.cpp
else
	echo "multi mode"
